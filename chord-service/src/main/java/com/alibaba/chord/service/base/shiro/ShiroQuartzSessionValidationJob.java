 ...
 * @Time:2017/6/19
 */
public class ShiroQuartzSessionValidationJob implements Job {
    /**
    ...
    ============================================*/
    private static final Logger log = LoggerFactory.getLogger(ShiroQuartzSessionValidationJob.class);
