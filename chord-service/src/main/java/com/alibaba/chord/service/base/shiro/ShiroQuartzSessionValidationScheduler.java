 ...
 * @Time:2017/6/19
 */
public class ShiroQuartzSessionValidationScheduler implements SessionValidationScheduler {
    public static final long DEFAULT_SESSION_VALIDATION_INTERVAL = DefaultSessionManager.DEFAULT_SESSION_VALIDATION_INTERVAL;
    private static final String JOB_NAME = "SessionValidationJob";
    private static final Logger log = LoggerFactory.getLogger(ShiroQuartzSessionValidationScheduler.class);
    private static final String SESSION_MANAGER_KEY = ShiroQuartzSessionValidationJob.SESSION_MANAGER_KEY;
    ...
    public ShiroQuartzSessionValidationScheduler() {
    }

    public ShiroQuartzSessionValidationScheduler(ValidatingSessionManager sessionManager) {
    ...
    public void enableSessionValidation() {
        ...
        try {
            ...
            JobDetail detail = JobBuilder
                .newJob(ShiroQuartzSessionValidationJob.class)
                .withIdentity(JOB_NAME, Scheduler.DEFAULT_GROUP)
                .build();
